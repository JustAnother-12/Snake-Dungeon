...
class HUD(pygame.sprite.Group):
    def __init__(self, coin, length) -> None:
        ...
        self.Gold_text = TextElement(str(coin), "white", 15, 6*constant.TILE_SIZE, int(9.5*constant.TILE_SIZE), "midleft")
        ...
        self.length_text = TextElement(str(length), "white", 15, 6*constant.TILE_SIZE, int(13.8*constant.TILE_SIZE), "midleft")
    ...
    def set_gold(self, num):
        ...
        self.Gold_text = TextElement(str(num), "white", 15, 6*constant.TILE_SIZE, int(9.5*constant.TILE_SIZE), "midleft")
    ...
    def set_lenght(self, len):
        ...
        self.length_text = TextElement(str(len), "white", 15, 6*constant.TILE_SIZE, int(13.8*constant.TILE_SIZE), "midleft")
